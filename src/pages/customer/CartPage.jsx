...
const CartPage = () => {
  ...
  const renderCartItem = React.useCallback((item, index) => (
    ...
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button 
            ...
            disabled={isSubmitting || !orderDetails.name || !orderDetails.phone || !orderDetails.address}
            startIcon={<SendIcon />}
          >
      ...
      >
        ...
        <DialogContent>
          ...
          <Box sx={{ mt: 3, border: "1px solid", borderColor: "divider", borderRadius: 2, overflow: "hidden" }}>
            <Box 
              ...
              sx={{ 
                p: 4,
                backgroundColor: menuStyle === "elegant" ? "#f9f5f0" : 
                                menuStyle === "modern" ? "#f0f6ff" : "#ffffff",
                backgroundImage: menuStyle === "elegant" ? `url(${defaultMenuBackground})` : "none",
            ...
            >
              <Box sx={{ 
                textAlign: "center", 
                mb: 4,
                borderBottom: menuStyle === "elegant" ? "2px solid #d4af37" : 
                               menuStyle === "modern" ? "none" : "1px solid #ddd",
                pb: 2
              }}>
                <Typography 
                  variant="h4" 
                  sx={{ 
                    fontWeight: "bold",
                    color: menuStyle === "elegant" ? "#8B4513" : 
                            menuStyle === "modern" ? "#1565c0" : "primary.main",
                    fontFamily: menuStyle === "elegant" ? "serif" : "inherit",
                    textShadow: menuStyle === "elegant" ? "1px 1px 2px rgba(0,0,0,0.3)" : "none"
                  }}
                >
                  Today's Menu
                </Typography>
              ...
              {menuStyle === "modern" && (
                <Box sx={{ display: "flex", justifyContent: "space-between", mb: 4 }}>
                  <Chip label="Today's Special" color="primary" sx={{ fontWeight: "bold" }} />
                ...
                {cartItems.map((item) => (
                  <Grid item xs={12} key={item._id}>
                    <Box sx={{
                      ...
                      backgroundColor: menuStyle === "modern" ? "rgba(0,0,0,0.02)" : "transparent",
                      borderRadius: menuStyle === "modern" ? 2 : 0,
                      mb: 1,
                      boxShadow: menuStyle === "modern" ? "0 2px 8px rgba(0,0,0,0.05)" : "none",
                      borderBottom: menuStyle === "elegant" ? "1px dotted #d4af37" : 
                                    menuStyle === "modern" ? "none" : "1px solid #eee"
                    }}>
                        ...
                        <Box sx={{ 
                          ...
                          <Typography 
                            ...
                            sx={{ 
                              fontWeight: "bold",
                              color: menuStyle === "elegant" ? "#8B4513" : 
                                     menuStyle === "modern" ? "#1565c0" : "text.primary",
                              fontFamily: menuStyle === "elegant" ? "serif" : "inherit"
                            }}
                          >
                            {item.name}
        ...
        <DialogActions>
          ...
          <Button 
            variant="contained" 
            startIcon={menuFormat === "pdf" ? <PictureAsPdfIcon /> : <ImageIcon />}
